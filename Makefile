...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Mi. Dez 5 11:41:09 2012
# Project:  Synchronizer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Synchronizer.pro
#############################################################################
...
compiler_moc_header_make_all: moc_demo.cpp moc_mp3decoder.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_demo.cpp moc_mp3decoder.cpp
moc_demo.cpp: recorder.h \
		synchronizer.h \
		demo.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) demo.h -o moc_demo.cpp

moc_mp3decoder.cpp: mp3decoder.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) mp3decoder.h -o moc_mp3decoder.cpp
